...
public class CompactorSourceBuilder {
    ...
    private Source<RowData, ?, ?> buildSource(CompactBucketsTable compactBucketsTable) {
        if (isContinuous) {
            ...
            return new ContinuousFileStoreSource(
                    generateReadBuilder(compactBucketsTable), compactBucketsTable.options(), null);
        } else {
            ...
            return new StaticFileStoreSource(
                    generateReadBuilder(compactBucketsTable),
                    null,
    ...
    private ReadBuilder generateReadBuilder(CompactBucketsTable compactBucketsTable) {
